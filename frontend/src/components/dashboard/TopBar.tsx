      ...
      <div className="px-6 lg:px-8 py-4 flex items-center justify-between gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl bg-white/[0.03] border border-white/10 text-sm focus:border-primary/60 focus:bg-white/[0.05] focus:outline-none placeholder:text-muted"
          />
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="absolute right-0 top-full mt-2 w-64 rounded-2xl bg-[#14102A] border border-white/10 shadow-2xl overflow-hidden py-2 z-50">
                ...
                <Link href="/dashboard/settings" onClick={() => setMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-2.5 text-sm text-text hover:bg-white/5 transition">
